...
<span class="publication-authors" markdown="span">Haocheng Ye<sup>*</sup>, Aoting Hu<sup>*</sup>, **<ins>Xinwei Zhang</ins>**✉️, Xunzhu Tang, Shuchao Pang, Jason Xue</span><br />
...
- **[USENIX SEC'26]** **[United We Defend: Collaborative Membership Inference Defenses in Federated Learning](https://www.usenix.org/conference/usenixsecurity26/presentation/bai)** ![CCF-A](https://img.shields.io/badge/CCF-A-red) <br />
...
- **[TDSC'26]** **[A Deep Dynamic Graph Generative Framework for Blockchain Phishing Detection](https://ieeexplore.ieee.org/document/11435482)** ![CCF-A](https://img.shields.io/badge/CCF-A-red) <br />
...
- **[WWW'25]** [**MER-Inspector: Assessing Model Extraction Risks from An Attack-Agnostic Perspective**](https://dl.acm.org/doi/abs/10.1145/3696410.3714894) ![CCF-A](https://img.shields.io/badge/CCF-A-red) <br />
...
- **[NeurIPS'25]** [**Toward Efficient Inference Attacks: Shadow Model Sharing via Mixture-of-Experts**](https://openreview.net/forum?id=bSs0d6NLiw&referrer=%5Bthe%20profile%20of%20Xinwei%20Zhang%5D) ![CCF-A](https://img.shields.io/badge/CCF-A-red) <br />
...
- **[TIFS'25]** [**ProVFL: Property Inference Attacks against Vertical Federated Learning**](https://ieeexplore.ieee.org/document/11045555) ![CCF-A](https://img.shields.io/badge/CCF-A-red) <br />
...
- **[TVT'24]** [**Enabling Deep Learning-based Physical-layer Secret Key Generation for FDD-OFDM Systems in Multi-Environments**](https://ieeexplore.ieee.org/document/10440494) ![JCR-Q1](https://img.shields.io/badge/JCR-Q1-red)<br />
...
- **[ICC'24]** [**A Secure and Reliable Blockchain-based Audit Log System**](https://ieeexplore.ieee.org/document/10623012) ![CCF-C](https://img.shields.io/badge/CCF-C-blue) <br />
...
- **[ICC'23]** [**DBE-voting: A Privacy-preserving and Auditable Blockchain-based E-voting System**](https://ieeexplore.ieee.org/document/10279692) ![CCF-C](https://img.shields.io/badge/CCF-C-blue) <br />
...
- **[IoT-J'22]** [**Deep Learning-based Physical-Layer Secret Key Generation for FDD Systems**](https://ieeexplore.ieee.org/document/9526766) ![JCR-Q1](https://img.shields.io/badge/JCR-Q1-red) <br />
...
- **[INFOCOM-W'21]** [**Secret Key Generation Scheme Based on Generative Adversarial Networks in FDD Systems**](https://ieeexplore.ieee.org/document/9484457) ![CCF-A Workshop](https://img.shields.io/badge/CCF--A-Workshop-red) <br />

...
- Blockchain: [[ICC'23](https://ieeexplore.ieee.org/document/10279692)]; [[ICC'24](https://ieeexplore.ieee.org/document/10623012)]; [[TDSC'26](https://ieeexplore.ieee.org/document/11435482)]
...
<style>
  .news-scroll-container {
    ...
    border-left: 0.5rem solid #d1d5db;
    border-radius: 1rem;
    background: #ffffff;
...
- *2026.06*: Invited to serve as a Program Committee member for [DSPP 2026](http://dspp2026.com/cfp).
...
- *2026.04*: Invited to serve as a reviewer for [NeurIPS 2026](https://neurips.cc/Conferences/2026).
- *2026.04*: Invited to serve as a Program Committee member for [ACM MM 2026](https://www.acmmm.org/2026/).
...
- *2026.01*: Invited to serve as a reviewer for [ICML 2026](https://icml.cc/Conferences/2026).
...
- *2021.09*: Our paper, **Deep Learning-based Physical-Layer Secret Key Generation for FDD Systems**, is accepted by IEEE Internet of Things Journal.
